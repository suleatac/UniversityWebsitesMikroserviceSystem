...
{
    public class OgrenciSeedExternalApiService
    {
        private readonly HttpClient _httpClient;
        private readonly ExternalOgrenciApiSettings _settings;
        private readonly ILogger<OgrenciSeedExternalApiService> _logger;

        public OgrenciSeedExternalApiService(
            HttpClient httpClient,
            IOptions<ExternalOgrenciApiSettings> settings,
            ILogger<OgrenciSeedExternalApiService> logger)
        {
