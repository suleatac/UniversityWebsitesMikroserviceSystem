...
{
    public class BirimCreatedEventConsumer : IConsumer<BirimCreatedEvent>
    {
        private readonly IRedisCacheService _cache;

        public BirimCreatedEventConsumer(IRedisCacheService cache)
        {
            _cache = cache;
        }

        public async Task Consume(ConsumeContext<BirimCreatedEvent> context)
        {
