...
{
    public class HaberDeletedEventConsumer : IConsumer<HaberDeletedEvent>
    {
        private readonly IRedisCacheService _cache;

        public HaberDeletedEventConsumer(IRedisCacheService cache)
        {
            _cache = cache;
        }

        public async Task Consume(ConsumeContext<HaberDeletedEvent> context)
        {
