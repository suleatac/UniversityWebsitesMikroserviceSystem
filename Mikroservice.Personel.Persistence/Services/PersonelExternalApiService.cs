...
{
    public class PersonelExternalApiService : IPersonelExternalApiService
    {
        private readonly HttpClient _httpClient;
        private readonly ExternalPersonelApiSettings _settings;
        private readonly ILogger<PersonelExternalApiService> _logger;

        public PersonelExternalApiService(
            HttpClient httpClient,
            IOptions<ExternalPersonelApiSettings> settings,
            ILogger<PersonelExternalApiService> logger)
        {
