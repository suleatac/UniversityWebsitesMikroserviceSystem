...
;(function($) {
   ...
   'use strict'
    ...
    var googleMap = function() {
        // google Maps JS API script'i _Layout'a eklenmediği için google.maps burada tanımsız kalabilir,
        // aksi halde attığı hata sonraki init çağrılarını (ör. article_carousel) da durduruyordu.
        if ( $().gmap3 && window.google && window.google.maps ) {
            $("#map").gmap3({
                map:{
                    options:{
                        zoom: 14,
