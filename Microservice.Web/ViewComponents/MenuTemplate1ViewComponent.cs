...
namespace Microservice.Web.ViewComponents
{
    ...
    public class MenuTemplate1ViewComponent : ViewComponent
    {
        // Mikroservice.Site.Domain.Enums.MenuLocation.Header karsiligi
        private const int HeaderLocation = 1;

        private readonly IMenuService _menuService;
        private readonly ILogger<MenuTemplate1ViewComponent> _logger;

        public MenuTemplate1ViewComponent(IMenuService menuService, ILogger<MenuTemplate1ViewComponent> logger)
        {
