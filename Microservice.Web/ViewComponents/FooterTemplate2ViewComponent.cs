...
{
    public class FooterTemplate2ViewComponent: ViewComponent
    {
        ...
        private readonly ILogger<FooterTemplate2ViewComponent> _logger;
        private readonly IBandLogoService _bandLogoService;
        private readonly IMenuService _menuService;
        private readonly IHaberService _haberService;

        public FooterTemplate2ViewComponent(
            ILogger<FooterTemplate2ViewComponent> logger,
