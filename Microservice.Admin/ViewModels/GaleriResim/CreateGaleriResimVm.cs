...
{
    // Mikroservice.Site.Application.Features.GaleriResimFeatures.CreateGaleriResim.CreateGaleriResimCommandValidation
    // kurallariyla paralel tutulmustur (istemci tarafi on dogrulama).
    public class CreateGaleriResimVm : IValidatableObject
    {
        ...
        [StringLength(150, ErrorMessage = "Kategori en fazla 150 karakter olabilir.")]
