...
{
    // Mikroservice.Site.Application.Features.GaleriResimFeatures.UpdateGaleriResim.UpdateGaleriResimCommandValidation
    // kurallariyla paralel tutulmustur (istemci tarafi on dogrulama).
    public class GaleriResimDetailVm : IValidatableObject
    {
