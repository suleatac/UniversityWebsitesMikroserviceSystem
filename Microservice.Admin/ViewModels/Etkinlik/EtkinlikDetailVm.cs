...
{
    // Mikroservice.Site.Application.Features.EtkinlikFeatures.UpdateEtkinlik.UpdateEtkinlikCommandValidation
    // kurallariyla paralel tutulmustur (istemci tarafi on dogrulama).
    public class EtkinlikDetailVm : IValidatableObject
    {
