...
{
    // Mikroservice.Site.Application.Features.EtkinlikFeatures.CreateEtkinlik.CreateEtkinlikCommandValidation
    // kurallariyla paralel tutulmustur (istemci tarafi on dogrulama).
    public class CreateEtkinlikVm : IValidatableObject
    {
