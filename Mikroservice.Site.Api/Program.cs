...
using Mikroservice.Site.Api.Endpoints.GaleriResimEndPoints;
using Mikroservice.Site.Api.Endpoints.HaberEndPoints;
using Mikroservice.Site.Api.Endpoints.HedefEndPoints;
using Mikroservice.Site.Api.Endpoints.IcerikEndPoints;
using Mikroservice.Site.Api.Endpoints.IletisimEndPoints;
...
using Mikroservice.Site.Api.Endpoints.ShortcutButtonEndPoints;
...
app.AddGaleriResimGroupsEndpointExt(apiVersionSet);
app.AddHaberGroupsEndpointExt(apiVersionSet);
app.AddHedefGroupsEndpointExt(apiVersionSet);
app.AddIcerikGroupsEndpointExt(apiVersionSet);
app.AddIletisimGroupsEndpointExt(apiVersionSet);
...
app.AddShortcutButtonGroupsEndpointExt(apiVersionSet);
